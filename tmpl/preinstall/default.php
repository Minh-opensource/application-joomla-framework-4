...
/** @var \Joomla\CMS\Alpha\View\Preinstall\HtmlView $this */
?>
			...
			<div class="col-md-12 mb-4">
				<div class="j-install-step active">
					<div class="j-install-step-header">
						<span class="fa fa-check" aria-hidden="true"></span> <?php echo Text::_('TXT_PRECHECK_TITLE'); ?>
					</div>
				...
				<?php if ($option->state === false && preg_match('$configuration.php$', $option->label)) : ?>
					<div id="ftpOptions" class="ftp-options mb-4 hidden">
						<form action="index.php" method="post" id="ftpForm" class="form-validate">
							<!-- 					<h3><?php echo Text::_('TXT_FTP'); ?></h3>
					<hr> -->
							<div class="form-group row">
								<div class="col-md-8 offset-md-2">
									<?php echo $this->form->getLabel('ftp_user'); ?>
									<?php echo $this->form->getInput('ftp_user'); ?>
									<p class="form-text text-muted small"><?php echo Text::_('TXT_FTP_USER_DESC'); ?></p>
								</div>
							</div>
							<div class="form-group row">
								<div class="col-md-8 offset-md-2">
									...
									<p class="form-text text-muted small"><?php echo Text::_('TXT_FTP_PASSWORD_DESC'); ?></p>
								</div>
							</div>
							<div class="form-group row mb-4">
								<div class="col-md-8 offset-md-2">
									...
									<div class="input-append d-flex">
										<?php echo $this->form->getInput('ftp_host'); ?><button id="findbutton" class="btn btn-secondary ml-2" onclick="Joomla.alpha.detectFtpRoot(this);"><span class="icon-folder-open"></span> <?php echo Text::_('TXT_AUTOFIND_FTP_PATH'); ?></button>
									</div>
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								<div class="col-md-8 offset-md-2 justify-content-end d-flex">
									<button id="verifybutton" class="btn btn-success"><span class="icon-ok icon-white"></span> <?php echo Text::_('TXT_VERIFY_FTP_SETTINGS'); ?></button>
								</div>
							</div>
